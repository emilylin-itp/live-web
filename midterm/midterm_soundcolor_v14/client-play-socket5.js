...
function plotSine(mouseX, mouseY, wavelength, step, yOffset, amplitudeSine, frequency, color, lineWidth) {
    ...
    setTimeout(fadeOutEffect(x, y, frequency, step, amplitudeSine), 2000);
...
///////////////////* FADE OUT EFFECT *//////////////////
function fadeOutEffect(x, y, frequency, step, amplitudeSine) {
    console.log('fade out effect now');
    ...
    while (x < wavelength) {
        ...
        let z = y + amplitudeSine * Math.sin((x + step) / frequency);
        ctx.lineTo(x, z);
        x++;
