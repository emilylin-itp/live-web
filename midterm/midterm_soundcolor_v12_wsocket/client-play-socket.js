...
function init() {
    ...
    //     plotSine(event.pageX, event.pageY, wavelength, 0, 0, amplitudeSine, rfreq, "#FD4F4F", lineWidth);//function plotSine(mouseX, mouseY, length, xOffset, yOffset,amplitude, frequency, color)
    ...
    redSelect.addEventListener('click', () => {
        ...
        canvas.addEventListener('click', (e) => {
            ...
            //socket.removeListener('sendRedData', e);
    ...
    function drawRedSine(data) {
        console.log('e.pageX: '+ data.clientX);
        console.log('e.pageY: '+ data.clientY);
        plotSine(data.clientX, data.clientY, wavelength, 0, 0, amplitudeSine, rfreq, "#FD4F4F", lineWidth);
        playRedFreq(); //play red sound         
    }
