...
function expandBottom() {
  ...
  if (bottomPlus.style.visibility === 'visible') {
    bottomX.style.visibility = 'hidden';
    bottomContainer.style.height = '12vh';
    bottomPlus.style.visibility = 'visible';
    console.log('bottom plus is visible');
  } else {
    bottomX.style.visibility = 'visible';
    bottomContainer.style.height = '25vh';
...
function minBottom() {
  ...
  if (bottomX.style.visibility === 'visible') {
    bottomX.style.visibility = 'hidden';
    bottomContainer.style.height = '12vh';
    bottomPlus.style.visibility = 'visible';
    console.log('bottom plus is visible');
