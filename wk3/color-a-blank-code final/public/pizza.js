...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let canvas = document.getElementById("mypizzacanvas");
    ...
    socket.on('drawPizzaLine', function (data) {
        ...
        var dcontext = document.getElementById("mypizzacanvas").getContext("2d");
    ...
    socket.on('pizzaclear', clearCanvas);
