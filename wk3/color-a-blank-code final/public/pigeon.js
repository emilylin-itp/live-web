...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let canvas = document.getElementById('mypigeoncanvas');
    ...
    socket.on('drawPigeonLine', function (data) {
        ...
        var dcontext = document.getElementById("mypigeoncanvas").getContext("2d");
    ...
    socket.on('pigeonclear', clearCanvas);
